...
function show_usage(){
    echo "Usage: trivy-scan.sh (-i <image> | -f path | -r path) [-s '/path1,/path2'] [-t https://trivy.example.com -k abc123] [-g graylog.example.com -p port] [-w duration] [-c /path/cache] [-u (os|library)]
